...
{{--                    <a href="index.html"><img src="assets/images/can.jpeg"  alt=""></a>--}}
                ...
                <div class="header-meta">
                    ...
                    <div class="header-toggle d-lg-none">
                        <button data-bs-toggle="offcanvas" datza-bs-target="#offcanvasExample">
                            <span></span>
                            <span></span>
                            <span></span>
                        </button>
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="single-blog">
                                <div class="blog-image">
                                    <a href=""><img loading="lazy" src=" {{ asset('storage/' . $blog->image) }}" alt="Picture"></a>
                                    <div class="top-meta">
{{--                                      dateday and month--}}
                                        @php
                                            $date = substr($blog->created_at, 0, 10);
                                            $dateDay = substr($date, 8, 2);
                                             $month = [
                                                ...
                                                $dateMonth = $month[substr($date, 5, 2)];
                               @endphp
                                        <span class="date"><span>{{ $dateDay }}</span>{{ $dateMonth }}</span>
                                    </div>
                                </div>
                                <div class="blog-content">
                                    <div class="blog-meta">
                                        <span><i class="fas fa-user"></i> <a href="#">{{ $blog->author }}</a></span>
                                        <span><i class="fa-brands fa-readme"></i> {{ $blog->id  }}</span>
                                    </div>
                                    @php
                                        $slug = substr($blog->slug, 0, 30);
                                    @endphp
...
<!-- Mirrored from thepixelcurve.com/html/techwix/techwix/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 16:41:23 GMT -->
</html>
